...
adt2_vts = pd.read_csv('/groups/dickson/home/bathd/Dropbox/THESIS/X001_P1VT_screen/adt2_vts.csv', sep=',')


ctrl_subset = raw[raw['vt_line'] == 'No-driver']
adt2_subset = raw[raw['vt_line'].isin(adt2_vts['adt2_vts'])]
...
adt2, blah3 = np.histogram(adt2_subset['score'], bins=np.linspace(0,1, num=num_bins+1))
adt2 = adt2.astype('float')
