...
def plot_from_csv(mean, sem, n):#, p_vals):
    fig = plt.figure()
    ...
    plt.show()
    fig.savefig('/groups/dickson/home/bathd/Dropbox/THESIS/X009_P1_adt2_co-activation/plot.svg', bbox_inches='tight')


colourlist = ['b','k','g','r','c','m','y']

    
means = pd.read_csv('/groups/dickson/home/bathd/Dropbox/THESIS/X009_P1_adt2_co-activation/means.csv',sep=',', index_col=0, header=0)
sems = pd.read_csv('/groups/dickson/home/bathd/Dropbox/THESIS/X009_P1_adt2_co-activation/sems.csv',sep=',', index_col=0, header=0)
