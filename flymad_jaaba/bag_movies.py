...
class FlyPanel(object):
    ...
    def get_data(self):
        ...
        if not os.path.exists(self._savedir +'/'+ self._handle + '_cache.pickle'):
            data = self.get_stims_from_bag(self._fmf_dir, (self._expdir + '/BAGS'), (self._expdir + '/'))
        ...
        frame_at_t0 = self.get_frame_number_at_or_before_timestamp(self._zoomfmf, zero_ts_float)
        return data, frame_at_t0    
